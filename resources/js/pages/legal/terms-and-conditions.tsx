                    ...
                    <div className="rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
                        ...
                        <div className="prose prose-gray dark:prose-invert max-w-none">
                            <section className="mb-8">
                                ...
                                <p className="mb-4 text-gray-700 dark:text-gray-300">
                                    Selamat datang di Kompeten. Syarat dan ketentuan ini mengatur penggunaan layanan pembelajaran online yang
                                    disediakan oleh CV. Kompeten ("kami", "kita", atau "Kompeten").
                                </p>
                                <p className="text-gray-700 dark:text-gray-300">
                                    Dengan mengakses dan menggunakan platform Kompeten, Anda menyetujui untuk terikat dengan syarat dan ketentuan ini.
                            ...
                            <section className="mb-8">
                                ...
                                <ul className="list-inside list-disc space-y-2 text-gray-700 dark:text-gray-300">
                                    <li>
                                        <strong>Platform:</strong> Website dan aplikasi Kompeten yang dapat diakses melalui kompeten.id
                                    </li>
                                    <li>
                            ...
                            <section className="mb-8">
                                ...
                                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                                    ...
                                    <p>Adalah milik Kompeten atau pembuat konten yang berlisensi kepada kami. Pengguna dilarang untuk:</p>
                                    <ul className="ml-4 list-inside list-disc space-y-1">
                            ...
                            <section className="mb-8">
                                ...
                                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                                    <p>Kompeten tidak bertanggung jawab atas:</p>
                                    <ul className="ml-4 list-inside list-disc space-y-1">
                        ...
                        <div className="mt-8 border-t border-gray-200 pt-8 text-center dark:border-gray-700">
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Dengan menggunakan layanan Kompeten, Anda menyetujui syarat dan ketentuan di atas.
                            </p>
                        </div>
                    </div>
                </div>
