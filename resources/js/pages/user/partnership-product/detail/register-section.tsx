...
export default function RegisterSection({ partnershipProduct }: { partnershipProduct: PartnershipProduct }) {
    ...
    return (
        <section className="mx-auto w-full space-y-4 md:p-4" id="register">
            <div className="rounded-2xl bg-neutral-100 p-6">
                <h2 className="mb-2 text-center text-2xl font-semibold text-gray-900 md:text-3xl dark:text-white">Informasi Pendaftaran</h2>
                ...
                <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div className="flex flex-col rounded-lg border border-gray-200 bg-white p-4 shadow-md dark:border-zinc-700 dark:bg-zinc-800">
                        ...
                        {partnershipProduct.price > 0 ? (
                            <span className="text-right text-3xl font-semibold text-gray-900 dark:text-gray-100">
